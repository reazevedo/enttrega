...
public class DetalhesEmpresaIdGUI extends JFrame implements ActionListener
{
	...
	public DetalhesEmpresaIdGUI(int indice) 
	{
	...
	public void actionPerformed(ActionEvent event) 
	{
		...
		{  
			...
			try
			{
				...
				{
					dispose();
					new DetalhesEmpresaGUI(getIndice(),getId());
				}    
				else{
					tID.setText("");
